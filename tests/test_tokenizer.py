...
# https://stackoverflow.com/questions/11293149/nltk-named-entity-recognition-in-dutch
    ...
    # B minor issue
    # B'Dit is één zin met St. Annastraat als enkele
    #      afkorting met hoofdletters.'
    #     "[['Dit', 'is', 'één', 'zin', 'met', 'St.', 'Annastraat', 'als',
    #       'enkele', 'afkorting', 'met', 'hoofdletters', '.']]",
    ...
    #     "[['Dit', 'is', 'één', 'zin', 'met', 'aanw. vnw.', 'als',
    #    'dubbele', 'afkorting', '.']]",
